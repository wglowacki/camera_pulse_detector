...
QT_MOC_LITERAL(1, 13, 10), // "drawPixmap"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6), // "pixmap"
QT_MOC_LITERAL(4, 32, 18), // "cameraDisconnected"
QT_MOC_LITERAL(5, 51, 15), // "currentFpsValue"
QT_MOC_LITERAL(6, 67, 5), // "value"
QT_MOC_LITERAL(7, 73, 3) // "end"

    },
    "CameraThread\0drawPixmap\0\0pixmap\0"
    "cameraDisconnected\0currentFpsValue\0"
    "value\0end"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->currentFpsValue((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->end(); break;
        default: ;
        }
        ...
        {
            typedef void (CameraThread::*_t)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::drawPixmap)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::cameraDisconnected)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (CameraThread::*_t)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::currentFpsValue)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::drawPixmap(QPixmap _t1)
{
...
// SIGNAL 1
void CameraThread::cameraDisconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void CameraThread::currentFpsValue(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
